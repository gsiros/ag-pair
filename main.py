...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=["vicuna-13b-v1.5", "llama-2-7b-chat-hf", "gpt-3.5-turbo-1106", "gpt-4-0125-preview", "claude-instant-1.2", "claude-2.1", "gemini-pro", "Qwen/Qwen3-VL-32B-Instruct", "gpt-4o"]
    )
    parser.add_argument(
        "--target-max-n-tokens",
        type = int,
